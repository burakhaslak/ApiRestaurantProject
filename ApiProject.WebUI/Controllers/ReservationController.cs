...
namespace ApiProject.WebUI.Controllers
{
    public class ReservationController : Controller
    {
        ...
        public async Task<IActionResult> ReservationList()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7072/api/Reservations");
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.DeleteAsync("https://localhost:7072/api/Reservations?id=" + id);
            return RedirectToAction("ReservationList");
        }
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync("https://localhost:7072/api/Reservations/GetReservation?id=" + id);
            var jsonData = await responseMessage.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> UpdateReservation(UpdateReservationDto updateReservationDto)
        {
            ...
            StringContent content = new StringContent(jsonData, Encoding.UTF8, "application/json");
            await client.PutAsync("https://localhost:7072/api/Reservations/", content);
            return RedirectToAction("ReservationList");
        }
    }
}
